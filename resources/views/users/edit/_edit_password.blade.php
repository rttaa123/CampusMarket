  ...
  <div class="card-body">
    <form action="{{ route('user_edit_password_check',$user) }}" method="POST">
      ...
      <div class="form-group form-check mb-2" style=" width:98px;right:20px">
        <button type="submit" class="btn " style="margin-right:10px;width:98px;color: white;background:linear-gradient(120deg,#E23729,#EC5E29);border:none;font-weight:bold;border-radius:10px;">
          确认修改
        </button>
      </div>

...
<div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 " style="margin-left: 60px;">
  ...
  <div class=" card mt-3">
    <div class="card-body" style="height: 55px;">
      {{-- 【新增】私信按钮：只有在已登录且非自己的主页时才显示 --}}
        @if (Auth::check() && Auth::id() != $user->id)
    <a href="{{ route('messages.show', ['user' => $user->id]) }}" 
       class="btn ml-1" style="font-weight:bold;background:linear-gradient(120deg,#E23729,#EC5E29);color:#fff;border:none;border-radius:8px;">
        <img src="/images/iconfont/email.png" class="mr-1" alt="" style="width: 20px;height:20px; vertical-align: middle;">
        私信 TA
    </a>
       @endif
      <div class="btn ml-1 btn_all_show" style="background:linear-gradient(120deg,#E23729,#EC5E29);color:#fff;border:none;">
          全部显示
      </div>

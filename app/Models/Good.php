...
class Good extends Model
{
  ...
  protected $fillable = [
    ...
    'view_count', 'user_id', 'tags', 'type','address','city','latitude','longitude',
  ];
  ...
  {
    return $this->belongsTo(Category::class,'category_id');   // 一个商品属于一个主分类
  }
  ...
  public function getCategoryNamesAttribute()
  {
    ...
    if ($this->category && !in_array($this->category->name, $names)) {
      $names[] = $this->category->name;
    }
    return $names;
  }

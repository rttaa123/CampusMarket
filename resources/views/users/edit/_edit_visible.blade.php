  ...
  <div class="card-body">
    <form action="" method="" autocomplete="off">
      ...
      <div class="form-group form-check mb-2 mt-5" style=" width:98px;right:20px">
        <button type="button" class="btn btn_visible" style="margin-right:10px;width:98px;color: white;background:linear-gradient(120deg,#E23729,#EC5E29);border:none;font-weight:bold;border-radius:10px;">
          确认修改
        </button>
      </div>

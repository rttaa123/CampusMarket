...
class PagesController extends Controller
{
  ...
  public function root(Request $request)
  {
    ...
    $goods = Good::where('state', Good::goods_state_in_selling)->orderBy('created_at', 'desc')->paginate(18);
  ...
  {
    $categories = Category::where('id', $category_id)->firstOrFail();

    $goods = $good->where('state', Good::goods_state_in_selling)

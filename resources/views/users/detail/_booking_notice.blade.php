...
<div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 " style="margin-left: 60px;margin-bottom:75px">
  <div class="card ">
    <div class="card-body">
      @php
        $sectionLabel = $isWishMode ? '心愿预订通知' : '预订通知';
      @endphp
      <div class="row ">
    ...
    <div class="card-body">
      ...
      <input type="text" value="{{ $user->id }}" id="user_id" hidden data-mode="{{ $isWishMode ? 'wish' : 'shop' }}">
                ...
                <div class="row no-gutters">
                  ...
                  <div class="ml-2" >
                    ...
                    <div class="card-text mt-2">
                      ...
                      <button type="button" data-id="{{ $value->id }}" class="btn btn-sm btn_refuse ml-2" style="width:58px;height:29px;color:#E23729;border:1.5px solid #E23729;background:transparent;">拒绝</button>
                    </div>
...
<script>
  $(document).ready(function() {
    var wishlistMode = $('#user_id').data('mode') || 'shop';
        ...
        axios.post('/agree_booking/'+ id).then(function(res){
          ...
          Swal.fire({
            ...
            if(res.dismiss == 'cancel') {
              ...
              var sellerOrderBase='{{ env("APP_URL") }}'+'/users/'+user_id+'/seller_order?';
              var sellerOrderQuery=(wishlistMode === 'wish' ? 'mode=wish&' : '')+'type=pending';
              window.location.href=sellerOrderBase+sellerOrderQuery

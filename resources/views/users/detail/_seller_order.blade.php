...
<div class="col-lg-6 col-md-7 col-sm-12 col-xs-12 " style="margin-left: 60px;margin-bottom:75px">
  <div class="card ">
    <div class="card-body">
      @php
        $sectionLabel = $isWishMode ? '实现心愿' : '出售订单';
        $searchAction = route('search_seller_order',$user->id);
        if($isWishMode){
          $searchAction .= '?mode=wish';
        }
      @endphp
      <div class="row ">
        <i class="{{ $isWishMode ? 'fas fa-hand-holding-heart' : 'far fa-envelope' }} mr-2 ml-3 mt-2" style="font-size: 26px;color:#636b6f"></i>
        <h1 class="ml-2 mt-2" style="line-height: 24px;color:#636b6f; font-size:20px;font-weight:bold; ">
          {{ $user->name }}
          <span style="letter-spacing:2px"> {{ $sectionLabel }}</span>
                  ...
                  <div id="collapse{{ $value->id }}" class="collapse " aria-labelledby="heading{{ $value->id }}" data-parent="#accordionExample" >
                    ...
                    <div  class="card-body row" style="display: flex;align-items:center; padding:7px">
                      ...
                      <div class="ml-2" style="width: 480px;">
                          ...
                          @if($isEffective)
                            ...
                            <div class="mt-2">
                              <span style="color:#636b6f;font-weight:600;font-size:14px;letter-spacing:0.7px">
                                【注】{{ seller_order_processed($value->seller_state,$value->buyer_state)[2] ?? '双方已确认订单信息！' }}
                              </span>
                            </div>
                            <div class="mt-3" style="display: flex; align-items: center; gap: 10px;">
                              ...
                              <button type="button" class="btn btn-sm btn_rating" style="color:#E23729;border:1px solid #E23729;background:transparent;" 
                                ...
                                data-rated-id="{{ $value->buyer_id }}"
                                style="width: 120px; height:35px;">
                                <i class="fas fa-star"></i> 评价买家
                              </button>
                              @else
                          ...
                          @elseif(seller_order_pending($value->seller_state,$value->buyer_state)[0])
                            <div>
                              <span style="color: #38c172;font-size:16px;letter-spacing:1px">
                                订单已生效
                              </span>
          ...
          <div class="form-group">
            ...
            <div class="rating-container">
              <div class="rating-stars">
                <input type="radio" name="score" id="star5_seller" value="5">
                <label for="star5_seller" class="star-label">★</label>
                <input type="radio" name="score" id="star4_seller" value="4">
                <label for="star4_seller" class="star-label">★</label>
                <input type="radio" name="score" id="star3_seller" value="3">
                <label for="star3_seller" class="star-label">★</label>
                <input type="radio" name="score" id="star2_seller" value="2">
                <label for="star2_seller" class="star-label">★</label>
                <input type="radio" name="score" id="star1_seller" value="1">
                <label for="star1_seller" class="star-label">★</label>
              </div>

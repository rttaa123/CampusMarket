  ...
  <div class="card-body">
    ...
    <form action="{{ route('user_edit_avatar_check', $user->id) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
      ...
      <div class="form-group form-check mb-2 mt-3" style=" width:98px;right:20px">
        <button type="button" class="btn btn_click" style="margin-right:10px;width:98px;color: white;background:linear-gradient(120deg,#E23729,#EC5E29);border:none;font-weight:bold;border-radius:10px;">
          上传头像
        </button>
